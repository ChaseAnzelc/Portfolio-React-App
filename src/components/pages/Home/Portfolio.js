...
return (
        <div id="projects" className="text-center paddsection">
            ...
            <div className="row">
                ...
                <div className="projects-list">
                    <ul className="nav list-unstyled" id="projects-filters">
                ...
                <div className="projects-container">
                    <div className="row">
                        <div className="col-lg-4 col-md-6 projects-thumbnail all webapp">
                            <Link to="/Projects/rbmarketplace">
                                 <img src="images/portfolio/rbmarketplace.jpg" alt="img"/>
                            </Link>
                        </div>
                        <div className="col-lg-4 col-md-6 projects-thumbnail all mobileapp">
                        ...
                        <div className="col-lg-4 col-md-6 projects-thumbnail webapp consoleapp">
                            <Link to="/Projects/bankingledger">
                                <img src="images/portfolio/banking.jpg" alt="img"/>
                            </Link>
                        </div>
                        <div className="col-lg-4 col-md-6 projects-thumbnail all consoleapp">
